...
import { deleteUser, forgotPassword, getAllUsers, getSingleUser, getUserDetails, login, logout, register, resetNewPassword, updatePassword, updateProfile, updateUserRole } from '../controllers/user.js';
